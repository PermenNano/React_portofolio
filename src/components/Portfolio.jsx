...
export const prototypes = [
  {
    ...
    repoUrl: 'https://github.com/PermenNano/tugas-web-hospital',
  ...
  },
  {
    ...
    link: '#',
    repoUrl: 'https://github.com/PermenNano/peduli_diri-pbo-starbhak',
  ...
  },
  {
    ...
    link: '#',
    repoUrl: 'https://github.com/PermenNano/Portofolio-vue',
  ...
  },
  {
    ...
    link: '#',
    repoUrl: 'https://github.com/PermenNano/Project-Excel-Pkl',
  ...
  },
  {
    ...
    link: '#',
    repoUrl: 'https://github.com/PermenNano/medicalchatbot-api',
  ...
  },
  {
    ...
    link: '#',
    repoUrl: 'https://github.com/PermenNano/brin_project1',
...
const Portfolio = () => {
  ...
  const cardClasses = isGridVisible ? "w-full" : "w-80 flex-shrink-0"; // Increased width for bigger text

  return (
    <section id="portfolio" className="py-16 max-w-7xl mx-auto px-4">
      <h2 className="text-5xl font-bold mb-12 text-center text-gray-800 dark:text-white">Portfolio</h2>
      <div className="relative mb-16">
        <div className="flex justify-between items-center border-b-2 border-purple-500 pb-2 mb-8">
          <h3 className="text-4xl font-bold text-left text-gray-700 dark:text-gray-300">
            Projects
          </h3>
          <button
            onClick={() => setIsGridVisible(!isGridVisible)}
            className="px-4 py-2 text-base font-semibold text-purple-600 dark:text-purple-400 rounded-full hover:bg-purple-100 dark:hover:bg-purple-900/50 transition-colors"
          >
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-8">
          {allTechnologies.map(tech => (
            <button
              ...
              className={`px-5 py-2 text-base font-semibold rounded-full transition-colors duration-300 ${activeFilter === tech
          ...
          {filteredPrototypes.map((prototype) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <h4 className="text-xl font-bold mb-2 text-gray-900 dark:text-white leading-tight">{prototype.title}</h4>
                <p className="text-base leading-relaxed mb-4 h-24 line-clamp-4 text-gray-600 dark:text-gray-300">
                  {prototype.description}
                </p>
                <div className="flex flex-wrap gap-2 mb-5">
                  {prototype.technologies.map((tech) => (
                    <span key={tech} className="text-sm font-semibold bg-purple-100 text-purple-800 dark:bg-purple-900/50 dark:text-purple-300 px-3 py-1 rounded-full">
                      {tech}
                    </span>
                  ))}
                </div>
                <Link
                  ...
                  className="mt-auto inline-block bg-gradient-to-r from-indigo-600 to-purple-700 text-white px-6 py-3 rounded-full hover:from-indigo-700 hover:to-purple-800 transition duration-300 ease-in-out text-base font-semibold w-full text-center"
                >
                  View Project
                </Link>
              </div>
